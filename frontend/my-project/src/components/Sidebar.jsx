...
const Sidebar = ({
  ...
  // Mobile sidebar open hone par body scroll disable
  useEffect(() => {
          ...
          >
            <div className="flex items-center">
              ...
              {!isCollapsed && (
                ...
                >
                  <h2 className="text-sm font-bold text-gray-500 truncate">
                    {username}
                  </h2>
            ...
            >
              <div className="relative h-full flex flex-col">
                  <div className={sidebarStyles.mobileHeader}>
                    <div className={sideStyles.mobileUserContainer}>
                      <div className={sidebarStyles.userInitials.base}>
                        {initial}

                      </div>
                      <div>
                        <h2 className="text-lg font-bold text-green-500">{username}</h2>
